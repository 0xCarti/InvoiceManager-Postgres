...
PERMISSION_DEFINITIONS: tuple[PermissionDefinition, ...] = (
    ...
    _perm("invoices.manage_payment", "invoices", "Manage Invoice Payment Status", "Mark invoices paid or unpaid."),
...
ENDPOINT_PERMISSION_RULES: dict[str, PermissionRequirement] = {
    ...
    "location.add_location": requirement(any_of=("locations.create",)),
    "location.edit_location": requirement(any_of=("locations.edit",)),
    "location.copy_location_items": requirement(any_of=("locations.manage_items",)),
    "location.view_stand_sheet": requirement(any_of=("locations.view",)),
    "location.email_stand_sheets": requirement(any_of=("locations.email_stand_sheets",)),
    "location.add_location_item": requirement(any_of=("locations.manage_items",)),
    "location.delete_location_item": requirement(any_of=("locations.manage_items",)),
    "location.view_locations": requirement(any_of=("locations.view",)),
    "location.delete_location": requirement(any_of=("locations.delete",)),
    ...
    "glcode_bp.view_gl_codes": requirement(any_of=("gl_codes.view",)),
    "glcode_bp.create_gl_code": requirement(any_of=("gl_codes.create",)),
    "glcode_bp.edit_gl_code": requirement(any_of=("gl_codes.edit",)),
    "glcode_bp.delete_gl_code": requirement(any_of=("gl_codes.delete",)),
    "glcode_bp.ajax_create_gl_code": requirement(any_of=("gl_codes.create",)),
    "glcode_bp.ajax_update_gl_code": requirement(any_of=("gl_codes.edit",)),
...
ENDPOINT_METHOD_PERMISSION_RULES: dict[tuple[str, str], PermissionRequirement] = {
    ...
    ("location.location_items", "GET"): requirement(any_of=("locations.view", "locations.manage_items")),
    ("location.location_items", "POST"): requirement(any_of=("locations.manage_items",)),
    ("location.bulk_update_locations", "GET"): requirement(any_of=("locations.bulk_update",)),
    ("location.bulk_update_locations", "POST"): requirement(any_of=("locations.bulk_update",)),
    ...
    ("admin.permission_groups", "POST"): requirement(any_of=("permission_groups.manage",)),
