...
PERMISSION_DEFINITIONS: tuple[PermissionDefinition, ...] = (
    ...
    _perm("equipment.view", "equipment", "View Equipment", "View equipment assets, details, and labels."),
    _perm("equipment.create", "equipment", "Create Equipment", "Create equipment assets."),
    _perm("equipment.edit", "equipment", "Edit Equipment", "Edit equipment assets."),
    _perm("equipment.archive", "equipment", "Archive Equipment", "Archive equipment assets."),
    _perm(
        "equipment.manage_intake",
        "equipment",
        "Manage Equipment Intake",
        "Create, edit, and receive equipment intake batches linked to purchasing records.",
    ),
    _perm(
        "equipment.manage_maintenance",
        "equipment",
        "Manage Equipment Maintenance",
        "Create, edit, and update equipment maintenance issues and work logs.",
    ),
    _perm(
        "equipment.manage_categories",
        "equipment",
        "Manage Equipment Categories",
        "Create, edit, and archive equipment categories.",
    ),
    _perm(
        "equipment.manage_models",
        "equipment",
        "Manage Equipment Models",
        "Create, edit, and archive equipment models.",
    ),
    _perm(
    ...
    _perm(
        ...
        "equipment",
        "Import Equipment",
        "Import equipment assets from Snipe-IT and other equipment data exports.",
    ),
    ...
    _perm("reports.event_spoilage", "reports", "Event Spoilage Report", "Run the event spoilage report."),
    ...
    _perm(
        ...
        "reports",
        "Equipment Procurement Report",
        "Run the equipment procurement and intake report.",
    ),
...
ENDPOINT_PERMISSION_RULES: dict[str, PermissionRequirement] = {
    ...
    "equipment.view_equipment_asset": requirement(any_of=("equipment.view",)),
    "equipment.view_equipment_intake": requirement(any_of=("equipment.view",)),
    "equipment.view_equipment_intake_batch": requirement(any_of=("equipment.view",)),
    "equipment.view_equipment_maintenance": requirement(any_of=("equipment.view",)),
    "equipment.view_equipment_maintenance_issue": requirement(any_of=("equipment.view",)),
    "equipment.create_equipment_asset": requirement(
        any_of=("equipment.create",),
        all_of=("equipment.view",),
    ),
    "equipment.edit_equipment_asset": requirement(
        any_of=("equipment.edit",),
        all_of=("equipment.view",),
    ),
    "equipment.archive_equipment_asset": requirement(
        any_of=("equipment.archive",),
        all_of=("equipment.view",),
    ),
    "equipment.create_equipment_intake_batch": requirement(
        any_of=("equipment.manage_intake",),
        all_of=("equipment.view",),
    ),
    "equipment.edit_equipment_intake_batch": requirement(
        any_of=("equipment.manage_intake",),
        all_of=("equipment.view",),
    ),
    "equipment.receive_equipment_intake_batch": requirement(
        any_of=("equipment.manage_intake",),
        all_of=("equipment.view",),
    ),
    "equipment.create_equipment_maintenance_issue": requirement(
        any_of=("equipment.manage_maintenance",),
        all_of=("equipment.view",),
    ),
    "equipment.edit_equipment_maintenance_issue": requirement(
        any_of=("equipment.manage_maintenance",),
        all_of=("equipment.view",),
    ),
    "equipment.add_equipment_maintenance_update": requirement(
        any_of=("equipment.manage_maintenance",),
        all_of=("equipment.view",),
    ),
    ...
    "equipment.view_equipment_catalog": requirement(
        any_of=("equipment.manage_categories", "equipment.manage_models"),
        all_of=("equipment.view",),
    ),
    "equipment.create_equipment_category": requirement(
        any_of=("equipment.manage_categories",),
        all_of=("equipment.view",),
    ),
    "equipment.edit_equipment_category": requirement(
        any_of=("equipment.manage_categories",),
        all_of=("equipment.view",),
    ),
    "equipment.archive_equipment_category": requirement(
        any_of=("equipment.manage_categories",),
        all_of=("equipment.view",),
    ),
    "equipment.create_equipment_model": requirement(
        any_of=("equipment.manage_models",),
        all_of=("equipment.view",),
    ),
    "equipment.edit_equipment_model": requirement(
        any_of=("equipment.manage_models",),
        all_of=("equipment.view",),
    ),
    "equipment.archive_equipment_model": requirement(
        any_of=("equipment.manage_models",),
        all_of=("equipment.view",),
    ),
    ...
    "locations.print_count_sign": requirement(any_of=("locations.edit",)),
    "locations.print_transfer_sign": requirement(any_of=("locations.edit",)),
    "locations.count_submissions": requirement(any_of=("events.manage_locations",)),
    "locations.count_submission_detail": requirement(any_of=("events.manage_locations",)),
    ...
    "report.index": requirement(
        any_of=(
            "reports.customer_invoices",
            "reports.received_invoices",
            ...
            "reports.product_recipe",
            "reports.product_location_sales",
            "reports.event_terminal_sales",
            "reports.event_spoilage",
    ...
    "report.event_spoilage_report": requirement(any_of=("reports.event_spoilage",)),
    "report.purchase_cost_forecast": requirement(any_of=("reports.purchase_cost_forecast",)),
    "report.equipment_procurement_report": requirement(
        any_of=("reports.equipment_procurement",)
    ),
    ...
    "event.download_event_document": requirement(any_of=("events.view",)),
    ...
    "event.confirm_event_location_day": requirement(
    ...
    "communication.messages": requirement(
        any_of=(
            "communications.view",
            "communications.view_history",
            "communications.send_direct",
    ...
    "communication.message_detail": requirement(
        any_of=(
            "communications.view",
            "communications.view_history",
            "communications.send_direct",
...
ENDPOINT_METHOD_PERMISSION_RULES: dict[tuple[str, str], PermissionRequirement] = {
    ...
    ("locations.count_submissions", "GET"): requirement(any_of=("events.manage_locations",)),
    ("locations.count_submission_detail", "GET"): requirement(any_of=("events.manage_locations",)),
    ("locations.count_submission_detail", "POST"): requirement(any_of=("events.manage_locations",)),
    ("locations.print_transfer_sign", "GET"): requirement(any_of=("locations.edit",)),
    ("event.upload_event_document", "POST"): requirement(any_of=("events.edit",)),
    ("event.delete_event_document_file", "POST"): requirement(any_of=("events.edit",)),
    ...
    ("communication.messages", "GET"): requirement(
        any_of=(
            "communications.view",
            "communications.view_history",
            "communications.send_direct",
    ...
    ("communication.messages", "POST"): requirement(
        any_of=(
            "communications.view",
            "communications.view_history",
            "communications.send_direct",
    ...
    ("communication.message_detail", "GET"): requirement(
        any_of=(
            "communications.view",
            "communications.view_history",
            "communications.send_direct",
