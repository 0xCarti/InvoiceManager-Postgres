(function () {
    ...
    modalFields = {
        ...
        typeField: document.getElementById("modal-block-type"),
        titleField: document.getElementById("modal-block-title"),
        menuColumnsField: document.getElementById("modal-block-menu-columns"),
        menuRowsField: document.getElementById("modal-block-menu-rows"),
        selectedProductsField: document.getElementById("modal-block-selected-products"),
        bodyField: document.getElementById("modal-block-body"),
        mediaAssetField: document.getElementById("modal-block-media-asset"),
        mediaUrlField: document.getElementById("modal-block-media-url"),
        showTitleField: document.getElementById("modal-block-show-title"),
        showPricesField: document.getElementById("modal-block-show-prices"),
        showMenuDescriptionField: document.getElementById("modal-block-show-description"),
